    ...
    <nav className={`bg-white dark:bg-gray-800 transition duration-300 border-b border-gray-600`}>
      <div className="flex justify-between items-center p-4">
        ...
        <div className="flex items-center gap-x-1 md:gap-x-5 text-sm md:text-md mr-2">
            <Link href='/home' className="hover:bg-slate-500 px-3 py-2 rounded-lg">Home</Link>
            <Link href='/home/appointments' className="hover:bg-slate-500 px-3 py-2 rounded-lg">Appointments</Link>
            <Link href='/profile'>
